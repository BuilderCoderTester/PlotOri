...
import { BookOpen, PenTool, Users, ArrowRight, Library, Feather, Quote } from "lucide-react";
...
function Home() {
  ...
  >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/draft">
                <Button size="lg" data-testid="button-begin-drafting" className="bg-white text-[hsl(158,50%,18%)] hover:bg-[hsl(158,20%,96%)] text-lg px-8 h-14 rounded-full font-semibold shadow-xl hover:-translate-y-1 transition-all duration-300">
                  Begin Drafting
                </Button>
              </Link>
              <Link href="/community">
                <Button size="lg" variant="outline" data-testid="button-explore-archive" className="border-white/30 bg-black/20 backdrop-blur-md text-white hover:bg-white/10 text-lg px-8 h-14 rounded-full font-semibold">
                  Explore The Archive
                </Button>
              </Link>
            </div>
